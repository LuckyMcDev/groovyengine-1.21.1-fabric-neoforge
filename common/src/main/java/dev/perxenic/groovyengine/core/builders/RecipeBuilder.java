package dev.perxenic.groovyengine.core.builders;

import java.util.HashMap;
import java.util.Map;

import dev.perxenic.groovyengine.GroovyEngine;
import dev.perxenic.groovyengine.datagen.builder.DatapackDataGenerator;
    ...
    public static class ShapedRecipeBuilder extends AbstractRecipeBuilder<ShapedRecipeBuilder> {
        ...
        public ShapedRecipeBuilder key(String symbol, String itemOrTagIdentifier) {
            if (symbol == null || symbol.length() != 1) {
                GroovyEngine.LOGGER.warn("RecipeBuilderApi.shaped('{}').key() received invalid symbol: '{}'", recipeId, symbol);
